...
{posts.map((post) => (
  <div className="bg-white shadow-lg border-2 border-black rounded-lg overflow-hidden" key={post._id}>
    <img
      src={post.images}
      alt="Coco"
    ...
    <div className="p-4">
      ...
      <p className="text-gray-600"><span className="font-bold mb-2 text-black">Status:</span> {post.adoptionStatus}</p>
      <p className="text-gray-600"><span className="font-bold mb-2 text-black">Desc:</span> {post.description}</p>
      <a
        href={`/pets/${post._id}`}
    ...
    <div class="mx-auto w-full max-w-screen-xl max-h-screen-2xl  p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="https://flowbite.com/" class="flex items-center">
                  <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 me-3" alt="FlowBite Logo" />
                  <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Hermies</span>
              </a>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a href="www.linkedin.com/in/ishan-saini-49b6842a6" class="hover:underline">Linkedin</a>
                      </li>
                      <li>
              ...
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a href="http://github.com/Webdev-Ishan" class="hover:underline ">Github</a>
                      </li>
                      <li>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">Hermies</a>. All Rights Reserved.
          </span>
