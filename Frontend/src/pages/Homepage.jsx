...
const Homepage = () => {
  ...
  return (
    <div className="font-sans">
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-600">
                    <span className="font-bold mb-2 text-black">Status:</span>{" "}
                    {post.adoptionStatus}
                  </p>
                  <p className="text-gray-600">
                    <span className="font-bold mb-2 text-black">Desc:</span>{" "}
                    {post.description}
                  </p>
                  <a
                    href={`/pets/${post._id}`}
      ...
      <section className="py-16 bg-gray-100">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center mb-8">What Pet Lovers Say</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Review 1 */}
          <div className="bg-white shadow-lg border-2 border-black rounded-lg overflow-hidden p-6">
            ...
            <p className="text-gray-700 text-sm">
              Adopting through this app was seamless. We found the perfect pet!
            </p>
          </div>
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                ...
                <ul class="text-gray-500 dark:text-gray-400 font-medium">
                  <li class="mb-4">
                    <a
                      href="www.linkedin.com/in/ishan-saini-49b6842a6"
              ...
              <div>
                ...
                <ul class="text-gray-500 dark:text-gray-400 font-medium">
                  <li class="mb-4">
                    <a
                      href="http://github.com/Webdev-Ishan"
                      class="hover:underline "
                    >
                      Github
                    </a>
